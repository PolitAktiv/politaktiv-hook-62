...
class FormulaAdd2AndMulOne extends MathCaptchaFormula {
	
	private int uA = 0, uB = 0, uC = 0;	
	
	public FormulaAdd2AndMulOne() {}
	...
	public String getQuestion() {
		String sTpl = "Addieren Sie %d und %d und multiplizieren das Ergebnis dann mit %d";
